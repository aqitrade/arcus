/*
 * Created on 29 Jan 2016 ( Time 20:42:46 )
...
public class ApplicationGroupEntity implements Serializable {
    ...
    //----------------------------------------------------------------------
    @OneToMany(mappedBy="applicationGroup", targetEntity=ApplicationEntity.class)
    private List<ApplicationEntity> listOfApplication;
    ...
    //----------------------------------------------------------------------
    public void setListOfApplication( List<ApplicationEntity> listOfApplication ) {
        this.listOfApplication = listOfApplication;
    }
    public List<ApplicationEntity> getListOfApplication() {
        return this.listOfApplication;
    }
